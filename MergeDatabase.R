...
#to do: copy survey and station data over.
dbfile1<-"D:/DataMerge/Manu_CameraBase_2016_2020.mdb"
dbfile2<-"D:/DataMerge/CameraTrapSurveyMT.mdb"

#fix issue in RODBC package
...
#show new species
species2[species2$NewSpecies==T,]
...
sp1<-getSpeciesSummary(cb1,10)
sp2<-getSpeciesSummary(cb2,20)
